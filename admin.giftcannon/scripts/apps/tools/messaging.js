define(["tools/hash"], function(hashlib){
    var opts = window.__options__, mevents = {}, msevents = {};
    mevents[opts.clickEvent+" .close"] = "clear";
    msevents[opts.clickEvent+" .message-container"] = "clear";
    ...
    var STORAGE_KEY = 'LS_USER_MESSAGES'
        , Message = Backbone.Model.extend({
            ...
            , initialize: function(json){
                var model = this;
                this.set({id: hashlib.default(JSON.stringify(json))});
        ...
        , View = Backbone.View.extend({
            ...
            , addOne : function(model){
                ...
                view.render().$el.appendTo(this.$el).closest(".message-container").removeClass("hide");
            }
            , render: function(){
                if(this.model.models.length){
                    this.$el.closest(".message-container").removeClass("hide");
                } else {
                    this.$el.closest(".message-container").addClass("hide");
                }
            }
        })
        , view = new View({el: opts.$messagingContainer})
